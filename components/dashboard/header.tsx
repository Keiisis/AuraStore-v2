...
import { Bell, Search, Menu, LogOut, User as UserIcon, Zap, Check } from "lucide-react";
                            ...
                            <div className="absolute right-0 top-full mt-2 w-80 bg-[#121216] border border-white/5 rounded-[2rem] p-4 shadow-2xl backdrop-blur-3xl z-[60] animate-in fade-in zoom-in-95 duration-200">
                                ...
                                {notifications.length > 0 && (
                                    <Link
                                        ...
                                        className="block text-center mt-4 py-3 bg-white/[0.03] hover:bg-white/[0.08] border border-white/[0.05] rounded-xl text-[9px] font-black uppercase tracking-widest text-white/40 transition-all"
