    ...
    return (
        <div className="min-h-screen bg-[#060608] text-white font-sans">
            ...
            <div className="fixed inset-0 pointer-events-none overflow-hidden">
                <div className="absolute -top-40 right-1/4 w-[600px] h-[600px] bg-[#FE7501] opacity-[0.03] blur-[180px] rounded-full" />
                <div className="absolute -bottom-40 left-1/4 w-[400px] h-[400px] bg-[#FE7501] opacity-[0.02] blur-[150px] rounded-full" />
            </div>

            <div className="relative z-10 max-w-[820px] mx-auto py-12 px-4 sm:px-8 space-y-10">
